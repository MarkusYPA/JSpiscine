async function isWinner(country) {
    try {
        ...
        const wins = await db.getResults(winner.id)
        ...
        // This happens when getWinner or I guess getResults throws an error
        return country + ' never was a winner'
    }
}

/* 
// function that has 2 arrays and returns  1 object
const db = (() => {
    ...
    // return is an object with four functions:
    // - async get one country by name
    // - async get array of results by country id
    // - add one country
